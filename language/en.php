...
$lang->uniSearchInput = 'Please input keywords';
$lang->uniSearchMore  = 'More results';
$lang->files          = 'Files';
...
$lang->uni->common->quick                      = 'Quick add';
...
$lang->uni->common->unfinishedPurchasecontract = 'Unfinished Purchase Contract';
...
$lang->uni->common->clearCache                 = 'Clear Cache';
$lang->uni->common->readAndAgree               = 'I have read and agree to the ';
$lang->uni->common->serviceAgreement           = 'service agreement';
$lang->uni->common->and                        = 'and';
$lang->uni->common->privacyPolicy              = 'privacy policy';
$lang->uni->common->readAndAgreeToast          = 'Please read and agree to the service agreement and privacy policy first';
...
$lang->setting->menu->refundReviewer  = 'Reimburse Reviewer|refund|setReviewer|module=setting';
$lang->setting->menu->refundCategory  = 'Reimburse Category|refund|setCategory|module=setting';
$lang->setting->menu->refundDepositor = 'Reimburse Account|refund|setDepositor|module=setting';
...
$lang->menu->team->user      = 'Staff|user|colleague|';
...
$lang->depositor->list           = 'Account List';
...
$lang->trade->saleContract     = 'Sale Contract';
$lang->trade->purchaseContract = 'Procurement Contract';
...
$lang->trade->createdBy        = 'CreatedBy';
$lang->trade->createdDate      = 'Created';
$lang->trade->editedBy         = 'EditedBy';
...
$lang->trade->investAmount     = 'Investment Amount';
...
$lang->trade->dateWidth->similar   = 230;
...
$lang->trade->settingList['lastCategory'] = 'End-level Category only';
...
$lang->trade->objectTypeList['contract'] = 'Sale Contract';
...
$lang->trade->similarTrade    = 'There are similar records in the system.';
...
$lang->contact->originAccount  = 'Other Account';
$lang->contact->status         = 'Status';
$lang->contact->subStatus      = 'Sub Status';
...
$lang->contact->last           = 'Last';
$lang->contact->visits         = 'Visits';
$lang->contact->ip             = 'IP';
...
$lang->contact->assignedBy     = 'Assigned By';
$lang->contact->assignedDate   = 'Assigned Date';
$lang->contact->ignoredBy      = 'Ignored By';
$lang->contact->ignoredDate    = 'Ignored Date';
...
$lang->purchasecontract->type          = 'Type';
...
$lang->purchasecontract->delivery      = 'Deliver';
$lang->purchasecontract->deliveredBy   = 'DeliveredBy';
$lang->purchasecontract->deliveredDate = 'Delivered';
$lang->purchasecontract->return        = 'Payment';
$lang->purchasecontract->unReturn      = 'Unpayment';
$lang->purchasecontract->returnedBy    = 'PaidBy';
$lang->purchasecontract->returnedDate  = 'Paid';
$lang->purchasecontract->status        = 'Status';
$lang->purchasecontract->subStatus     = 'Sub Status';
$lang->purchasecontract->contact       = 'Contact';
$lang->purchasecontract->address       = 'Address';
...
$lang->purchasecontract->handlers      = 'Contributors';
...
$lang->purchasecontract->deleted       = 'Deleted';

$lang->purchasecontract->browse           = 'Contract';
$lang->purchasecontract->pay              = 'Pay';
...
$lang->purchasecontract->tradeList        = 'Expend List';
...
$lang->purchasecontract->totalAmount      = 'The total payment is %s. Paid %s on this page. Unpaid %s on this page. %s in this month.';
...
$lang->purchasecontract->action->paid       = '$date, a payment $extra is paid by <strong>$actor</strong>.' . "\n";
...
$lang->purchasecontract->action->finishpaid = '$date, a payment $extra is paid by <strong>$actor</strong>. Payment is completed' . "\n";
/* crm/sales */
if(!isset($lang->sales)) $lang->sales = new stdclass();
...
$lang->contract->totalAmount        = 'The total payment is %s. Received %s on this page. UnReceived %s on this page. Received %s in this month.';
...
$lang->leads->originAccount  = 'Origin Account';
...
$lang->leads->assignedBy     = 'AssignBy';
$lang->leads->assignedDate   = 'Assigned Date';
$lang->leads->ignoredBy      = 'IgnoredBy';
$lang->leads->ignoredDate    = 'Ignored Date';
...
$lang->refund->browse       = 'Reimburse List';
$lang->refund->list         = 'Reimburse List';
...
$lang->refund->submitSuccess     = 'Submitted.';
...
$lang->attend->edited       = 'Clockin';
$lang->attend->leave        = 'Leave';
$lang->attend->leaved       = 'Leave asked';
$lang->attend->makeup       = 'Leave Makeup';
$lang->attend->makeuped     = 'Leave Makeup done';
...
$lang->attend->manualIn     = 'Clockin';
$lang->attend->manualOut    = 'Clockout';
$lang->attend->reason       = 'Reason';
$lang->attend->reviewStatus = 'Review';
$lang->attend->reviewedBy   = 'ReviewedBy';
...
$lang->attend->statusList['makeup']   = 'Leave Makeup';
...
$lang->attend->inFail     = 'Clockin failed.';
$lang->attend->outSuccess = 'Clocked out.';
$lang->attend->outFail    = 'Clockout failed.';

$lang->attend->signInLimit   = 'Clockin';
$lang->attend->signOutLimit  = 'Clockout';
...
$lang->attend->settings         = 'Company';
$lang->attend->personalSettings = 'Personal';
$lang->attend->setManager       = 'Dept. Manager';
...
/* sys/provider */
$lang->provider->browse      = 'Supplier';
$lang->provider->create      = 'Create Supplier';
...
$lang->provider->common        = 'Supplier';
$lang->provider->id            = 'ID';
$lang->provider->name          = 'Name';
$lang->provider->depositor     = 'Account';
$lang->provider->contact       = 'Contact';
$lang->provider->type          = 'Type';
$lang->provider->source        = 'Source';
$lang->provider->sourceNote    = 'Note';
$lang->provider->size          = 'Size';
$lang->provider->industry      = 'Industry';
$lang->provider->area          = 'Area';
$lang->provider->status        = 'Status';
$lang->provider->subStatus     = 'Sub Status';
$lang->provider->level         = 'Level';
$lang->provider->intension     = 'Intention';
...
$lang->provider->public        = 'Public';
$lang->provider->relation      = 'Relation';
$lang->provider->createdBy     = 'CreatedBy';
$lang->provider->createdDate   = 'Created';
$lang->provider->editedBy      = 'EditedBy';
$lang->provider->editedDate    = 'Edited';
$lang->provider->assignedTo    = 'Assignee';
$lang->provider->assignedBy    = 'AssignedBy';
$lang->provider->assignedDate  = 'Assigned';
$lang->provider->contactedBy   = 'ContactBy';
$lang->provider->contactedDate = 'Contact';
$lang->provider->nextDate      = 'Next Contact';
$lang->provider->deleted       = 'Deleted';
$lang->provider->createContact = 'Create Contact';

$lang->provider->relationList['client']   = 'Client';
$lang->provider->relationList['provider'] = 'Supplier';
...
$lang->action->desc->reviewedback          = '$date, reviewed back date by <strong>$actor</strong>.' . "\n";
...
$lang->action->desc->submitted             = '$date, submited by <strong>$actor</strong>.' . "\n";
...
$lang->action->desc->paid                  = '$date, a payment $extra is paid by <strong>$actor</strong>.' . "\n";
$lang->action->desc->editpaid              = '$date, edited payment by <strong>$actor</strong>.' . "\n";
$lang->action->desc->deletepaid            = '$date, deleted $extra by <strong>$actor</strong>.' . "\n";
$lang->action->desc->finishpaid            = '$date, a payment $extra is paid by <strong>$actor</strong>. Payment is completed' . "\n";
...
$lang->action->desc->paycontract           = '$date, $extra by <strong>$actor</strong>.' . "\n";
...
$lang->action->desc->finishpaycontract     = '$date, $extra by <strong>$actor</strong>. The payment is completed.' . "\n";
...
$lang->action->desc->finishdating          = '$date, <strong>$actor</strong> Finished Next Contact：<strong>$extra</strong>。' . "\n";
$lang->action->desc->deletedating          = '$date, <strong>$actor</strong> Deleted Next Contact：<strong>$extra</strong>。' . "\n";
...
$lang->action->label->submitted          = 'submitted';
...
$lang->action->label->deletedating       = 'deleted next contact';
$lang->action->label->finishdating       = 'finished next contact';
...
$lang->action->label->createdbalance     = 'add balance';
$lang->action->label->forbidden          = 'forbidden';
...
$lang->action->label->deletereturned        = 'delete returned';
$lang->action->label->paycontract           = 'pay';
$lang->action->label->finishpaycontract     = 'finish paid';
$lang->action->label->paid                  = 'return';
$lang->action->label->editpaid              = 'edit paid';
$lang->action->label->finishpaid            = 'finish paid';
$lang->action->label->deletepaid            = 'delete paid';
$lang->action->label->moved2customerpool    = 'move to customer pool';
...
$lang->action->label->purchasecontract['common'] = 'Purchase Contract|purchasecontract|view|contractID=%s';
$lang->action->label->attend = array();
$lang->action->label->attend['common']    = 'attend review|attend|browsereview|';
$lang->action->label->attend['submitted'] = 'attend review|attend|browsereview|';
...
$lang->action->label->leave['submitted']    = 'leave review|leave|browsereview|';
...
$lang->action->label->leave['reviewedback'] = 'leave review|leave|personal|';
...
$lang->action->label->lieu['submitted'] = 'lieu review|lieu|browsereview|';
...
$lang->action->label->makeup['submitted'] = 'makeup review|makeup|browsereview|';
...
$lang->action->label->overtime['submitted'] = 'overtime review|overtime|browsereview|';
...
$lang->action->label->refund['submitted']   = 'refund review|refund|browsereview|';
...
$lang->action->record->contract         = 'Sale Contract';
$lang->action->record->purchasecontract = 'Purchase Contract';
...
$lang->action->record->nextDate         = 'Date';
$lang->action->record->nextContact      = 'Contact';
...
$lang->action->objectTypes['contract']         = 'Sale Contract';
$lang->action->objectTypes['purchasecontract'] = 'Purchase Contract';
...
$lang->report->customer->item['assignedTo'] = 'Assigned To';
...
$lang->report->order->item['assignedTo']   = 'Assigned';
$lang->report->order->item['createdBy']    = 'Created';
...
$lang->report->order->item['assignedToA']  = 'Assigned';
$lang->report->order->item['createdByA']   = 'Created';
...
$lang->report->contract->common = 'Sale Contract Report';
...
$lang->report->contract->chartList['customerA']    = 'Customer (Amount)';
...
$lang->report->contract->item['createdBy']    = 'Created';
$lang->report->contract->item['signedBy']     = 'Signed';
$lang->report->contract->item['deliveredBy']  = 'Delivered';
$lang->report->contract->item['contactedBy']  = 'Contacted';
...
$lang->report->contract->item['createdByA']   = 'Created';
$lang->report->contract->item['signedByA']    = 'Signed';
$lang->report->contract->item['deliveredByA'] = 'Delivered';
$lang->report->contract->item['contactedByA'] = 'Contacted';
...
$lang->report->contract->value['customerA']    = 'Amount';
...
$lang->report->purchasecontract->common = 'Purchase Contract Report';
$lang->report->purchasecontract->chartList['customer']     = 'Supplier (Number)';
$lang->report->purchasecontract->chartList['status']       = 'Status (Number)';
$lang->report->purchasecontract->chartList['return']       = 'Payment (Number)';
$lang->report->purchasecontract->chartList['createdBy']    = 'CreatedBy (Number)';
$lang->report->purchasecontract->chartList['signedBy']     = 'SignedBy (Number)';
$lang->report->purchasecontract->chartList['contactedBy']  = 'ContactedBy (Number)';
$lang->report->purchasecontract->chartList['year']         = 'Year (Number)';
$lang->report->purchasecontract->chartList['month']        = 'Month (Number)';
$lang->report->purchasecontract->chartList['customerA']    = 'Supplier (Amount)';
$lang->report->purchasecontract->chartList['statusA']      = 'Status (Amount)';
$lang->report->purchasecontract->chartList['returnA']      = 'Payment (Amount)';
$lang->report->purchasecontract->chartList['createdByA']   = 'CreatedBy (Amount)';
$lang->report->purchasecontract->chartList['signedByA']    = 'SignedBy (Amount)';
$lang->report->purchasecontract->chartList['contactedByA'] = 'ContactedBy(Amount)';
$lang->report->purchasecontract->chartList['yearA']        = 'Year (Amount)';
$lang->report->purchasecontract->chartList['monthA']       = 'Month (Amount)';

$lang->report->purchasecontract->item['customer']     = 'Provider';
$lang->report->purchasecontract->item['status']       = 'Status';
$lang->report->purchasecontract->item['return']       = 'Payment';
$lang->report->purchasecontract->item['createdBy']    = 'Created';
$lang->report->purchasecontract->item['signedBy']     = 'Signed';
$lang->report->purchasecontract->item['contactedBy']  = 'Contacted';
$lang->report->purchasecontract->item['year']         = 'Year';
$lang->report->purchasecontract->item['month']        = 'Month';
$lang->report->purchasecontract->item['customerA']    = 'Provider';
$lang->report->purchasecontract->item['statusA']      = 'Status';
$lang->report->purchasecontract->item['returnA']      = 'Payment';
$lang->report->purchasecontract->item['createdByA']   = 'Created';
$lang->report->purchasecontract->item['signedByA']    = 'Signed';
$lang->report->purchasecontract->item['contactedByA'] = 'Contacted';
$lang->report->purchasecontract->item['yearA']        = 'Year';
$lang->report->purchasecontract->item['monthA']       = 'Month';

$lang->report->purchasecontract->value['customer']     = 'Number';
$lang->report->purchasecontract->value['status']       = 'Number';
$lang->report->purchasecontract->value['return']       = 'Number';
$lang->report->purchasecontract->value['createdBy']    = 'Number';
$lang->report->purchasecontract->value['signedBy']     = 'Number';
$lang->report->purchasecontract->value['contactedBy']  = 'Number';
$lang->report->purchasecontract->value['year']         = 'Year';
$lang->report->purchasecontract->value['month']        = 'Month';
$lang->report->purchasecontract->value['customerA']    = 'Amount';
$lang->report->purchasecontract->value['statusA']      = 'Amount';
$lang->report->purchasecontract->value['returnA']      = 'Amount';
$lang->report->purchasecontract->value['createdByA']   = 'Amount';
$lang->report->purchasecontract->value['signedByA']    = 'Amount';
$lang->report->purchasecontract->value['contactedByA'] = 'Amount';
$lang->report->purchasecontract->value['yearA']        = 'Amount';
$lang->report->purchasecontract->value['monthA']       = 'Amount';
...
$lang->customer->subStatus     = 'Sub Status';
$lang->customer->level         = 'Level';
$lang->customer->intension     = 'Intention';
$lang->customer->mobile        = 'Mobile';
...
$lang->customer->category      = 'Category';
...
$lang->customer->lastDate      = 'Last Contact';
$lang->customer->nextDate      = 'Next Contact';
$lang->customer->deleted       = 'Deleted';
...
$lang->entry->note->navigation = 'Hide left navigation';
...
$lang->schema->fileType = 'File Type';
...
$lang->thread->threadNotExist  = "The thread doesn't exist";

...
$modules  = $out[0];
if(!$modules) die("$filePath can't be separated because the file doesn't have the module marks such as '/* sys/common */'.\n");
...
$appRoot = "extLang_$lang" . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR;
if($extPath) $appRoot = $extPath . DIRECTORY_SEPARATOR . $appRoot;
